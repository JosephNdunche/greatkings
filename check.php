...
<?php require_once "includes/staff-profile.inc.php"; ?>


<?php  require "includes/staff-update-profile.inc.php"; ?>
                  <!-- Profile Edit Form -->
                  <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="state_of_origin" type="text" class="form-control" id="state_of_origin" placeholder="<?php if(isset($state_of_origin)){
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="date_of_birth" type="date" class="form-control" id="date_of_birth" placeholder="<?php if(isset($date_of_birth)){
                          echo $date_of_birth;
                        }else{
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="address" type="text" class="form-control" id="Address" placeholder="<?php if(isset($address)){
                          echo $address;
                        }else{
