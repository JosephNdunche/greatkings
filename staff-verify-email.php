...
<section class="signup py-4">
    <div class="container">
        ...
        Your unique id is <span class="text-success"><?php echo $_SESSION['staff']; ?></span>, keep it really well to access this account. <br /><br /> 
    ...
    <p class="text-center"><a href="staff-dashboard.php" class="bg-success text-white rounded form-control">Continue</a></p>
    </div>
</section>
