...
require "includes/user-update-profile.inc.php";
?>
          ...
          <div class="card">
            <div class="card-body pt-3">
                  ...
                  <form method="POST" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                    ...
                    <div class="row mb-3">
                      <label for="parent_surname" class="col-md-4 col-lg-3 col-form-label">Parent Surname</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="parent_surname" type="text" class="form-control" id="parent_surname" value="<?php if(isset($_SESSION['parent_surname'])){
                          echo $_SESSION['parent_surname'];
                        }  ?>">
                    ...
                    <div class="row mb-3">
                      <label for="parent_other_names" class="col-md-4 col-lg-3 col-form-label">Parent Other Names</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="parent_other_names" type="text" class="form-control" id="parent_other_names" value="<?php if(isset($_SESSION['parent_other_names'])){
                          echo $_SESSION['parent_other_names'];
                        }  ?>">
                        <div class="text-danger">
                          <?php
                    ...
                    <div class="row mb-3">
                      <label for="student_names" class="col-md-4 col-lg-3 col-form-label">Student Names</label>
                      <div class="col-md-8 col-lg-9">
                        <input name="student_names" type="text" class="form-control" id="student_names" value="<?php if(isset($_SESSION['student_names'])){
                          echo $_SESSION['student_names'];
                        }  ?>">
                        <div class="text-danger">
                          <?php
                    ...
                    <div class="row mb-3">
                      <label for="date_of_birth" class="col-md-4 col-lg-3 col-form-label">Student Date of Birth</label>
                      <div class="col-md-8 col-lg-9">
                    ...
                    <div class="text-center">
                      <button type="submit" name="user-update-profile" class="btn btn-primary">Save Changes</button>
                    </div>
