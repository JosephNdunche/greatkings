...
?>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1 class="text-black">Hi, <span class="text-success"><?php echo $_SESSION['parent_surname']; ?></span></h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="user-dashboard.php">Parent</a></li>
...
<div class="col-lg-8">
      ...
      $sql = "SELECT * FROM pta WHERE user='parents' ORDER BY date desc";
              ...
              <div class="card info-card sales-card">
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center">
                    ...
                    <div class="ps-1">
                      <h6>Welcome, <?php echo $_SESSION['parent_surname']; ?></h6>
